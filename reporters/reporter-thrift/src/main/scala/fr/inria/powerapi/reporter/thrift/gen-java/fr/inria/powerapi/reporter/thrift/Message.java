...
public class Message implements org.apache.thrift.TBase<Message, Message._Fields>, java.io.Serializable, Cloneable {
  ...
  public Message(Message other) {
    if (other.isSetContent()) {
      Map<String,String> __this__content = new HashMap<String,String>();
      for (Map.Entry<String, String> other_element : other.content.entrySet()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                for (int _i1 = 0; _i1 < _map0.size; ++_i1)
                {
                  ...
                  struct.content.put(_key2, _val3);
                }
                iprot.readMapEnd();
              }
      ...
      if (incoming.get(0)) {
        {
          ...
          for (int _i7 = 0; _i7 < _map6.size; ++_i7)
          {
            ...
            struct.content.put(_key8, _val9);
          }
        }
        struct.setContentIsSet(true);
      }
